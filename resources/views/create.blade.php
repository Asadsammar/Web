    ...
    <div class="container ">
        ...
        <div class="card border-0 shadow-lg">
          ...
          <div class="mb-3">
               ...
               <input type="text" name="name_of_goods" placeholder="Enter Name Of Goods" class="form-control">
          </div>

          <div class="mb-3">
               <label for="catagory_item" class="form-label">Catagory Item</label>
               <input type="text" name="catagory_item" placeholder="Enter Catagory Item" class="form-control">
          </div>
